...
$result = mysql_query("SELECT * FROM iplace WHERE eemail='$eemail'");
	...
	$idplace = $row['eidplace'];
      ...
      //echo "Stored in: " . "upload/" . $_FILES["file"]["name"];
	  $picname = $idplace.'.jpg';;// $_FILES["file"]["name"];
    //$imgdb = "img_url='$img_url',";
 $eppic = $picname;
      $path1 ="../temp/".$picname;
	  //$path1main = $upload_dir."".$picname;
...
$result = mysql_query("UPDATE iplace SET $imgdb elatitude='$elatitude',elongitude='$elongitude',eaddress='$eaddress',eemail='$eemail',ecnumber='$ecnumber',ecnumber2='$ecnumber2',ecity='$ecity',etype='$etype',epname='$epname',edetails='$edetails' WHERE eidplace = '$idzz'");

echo "UPDATE iplace SET $imgdb elatitude='$elatitude',elongitude='$elongitude',eaddress='$eaddress',eemail='$eemail',ecnumber='$ecnumber',ecnumber2='$ecnumber2',ecity='$ecity',etype='$etype',epname='$epname',elocation='$ecountry',estatus='$estatus',eadminid='$eadminid',erank='$erank',edatereg='$edatereg',esubtype='$esubtype',edetails='$edetails' WHERE eidplace = '$idzz'";
...
if($idzz!="")	{
	...
	$result = mysql_query("SELECT * FROM iplace WHERE eidplace = '$idzz'");
	while($row = mysql_fetch_array($result)) {
...
<table width="100%" border="0" style="margin-top:100px">
  ...
  <tr>
    ...
    <td bgcolor="">
          <?php if($eppic!=""){echo '<img src="../place/small/'.$eppic.'"/><br />';} ?>
