...
define('NICUPLOAD_PATH', './../uploaded'); // Set the path (relative or absolute) to
                                      // the directory to save image files
                                      
define('NICUPLOAD_URI', '../uploaded');   // Set the URL (relative or absolute) to
